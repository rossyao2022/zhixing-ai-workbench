...
def main() -> None:
    ...
    required = [
        ...
        checks.get("desktop_books_per_stage") == [3, 3, 4, 3, 3, 3, 3, 3],
        checks.get("desktop_core_book_count") == 25,
        ...
        checks.get("mobile_books_per_stage") == [3, 3, 4, 3, 3, 3, 3, 3],
        checks.get("mobile_core_book_count") == 25,
