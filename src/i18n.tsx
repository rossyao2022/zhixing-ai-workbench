...
const messages: Record<string, MessageTuple> = {
  ...
  "payment.reference": ["支付凭证号后 6 位（选填）", "Last 6 payment reference digits (optional)", "Últimos 6 dígitos (opcional)", "भुगतान संदर्भ के अंतिम 6 अंक (वैकल्पिक)", "آخر 6 أرقام من مرجع الدفع (اختياري)"],
  "payment.referencePlaceholder": ["建议填写，便于快速审核", "Recommended for faster review", "Recomendado para revisión rápida", "तेज समीक्षा के लिए सुझाया गया", "يوصى به لتسريع المراجعة"],
