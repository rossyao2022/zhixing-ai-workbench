...
OUT = Path(os.environ.get(
    "LESSON1_OUTPUT_DIR",
    ROOT.parent / "outputs" / "lesson1-feishu-delivery",
))
FRAMES = OUT / "slide-images"
URL = os.environ.get(
    "QINGMI_WEB_PPT_URL",
    "http://127.0.0.1:43175/kuakua-ai/slides/lesson-01-business-model-canvas/index.html",
)
...
def main():
    ...
    if any(item["overflowX"] > 2 or item["overflowY"] > 2 for item in entries):
        raise RuntimeError("One or more desktop slides overflow their canvas")
